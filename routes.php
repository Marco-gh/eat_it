...
/*
Raggruppiamo tutte le routes a seguire sotto un gruppo in modo che, prima che vengano svolte, bisognerà effettuare
l'AuthMiddleware: potremo accedere alle routes del gruppo solo dopo aver verificato che l'utente che ha fatto la richiesta
è effettivamente autenticato, altrimenti le pagine non si potrebbero visualizzare senza errori.
Se no, redirect su login.
*/
SimpleRouter::group(['middleware' => \App\Controllers\AuthMiddleware::class], function () {
    ...
    /*
    Effettuiamo la verifica che il carrello associato all'ordine che si vuole effettuare si vuoto o no.
    Se no, redirect sulla home.
    */
...
/*
Raggruppiamo tutte le routes a seguire sotto un gruppo in modo che, prima che vengano svolte, bisognerà effettuare
l'AdminMiddleware: potremo accedere alle routes del gruppo solo dopo aver verificato che l'utente che ha fatto la richiesta
è effettivamente l'admin, altrimenti le pagine non si potrebbero visualizzare senza errori e senza falle di sicurezza.
Se no, redirect su login.
*/
